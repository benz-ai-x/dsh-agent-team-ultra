...
| 维护 fork / Maintained fork | `fb03045fbe1a2433d5cf43d766a25ebef5009094`, `0.1.2-rc.1` | 阶段 B 成员查询运行源 / Phase B member-query runtime source |
...
| 文档摘要 / Documentation digest | `f34086b46fe7e1cfdabbdc335a4ea5a8fe8beb23f0fab5a2b443d606e9b66432` | 锁定文档内容 / locked documentation content |
...
| [fb03045fbe](https://github.com/benz-ai-x/deepseek-harness_x/commit/fb03045fbe1a2433d5cf43d766a25ebef5009094) | Team 所有者签发可撤销成员 grant；三项真实 roster/task 查询 / revocable member authority and three canonical reads | 无新增持久字段／版本 / no durable format change | `native-member-operations.spec.ts`, `native-member-loader.e2e.ts`, built `snapshots/session/agent-team-profile` recorded queries; branded `TeamTaskId` cursor; Ultra Codex query integration and installed JSON/SQLite recovery; [ADR 0017](../adr/0017-authorize-native-team-member-queries.md) | maintained branch `fix/ultra-26-native-team-queries`; four affected source files pass 100% scoped coverage; build, Loader, docs and lint validated |
