...
| 维护 fork / Maintained fork | `d5eca257c2a0a21392ae8af0ee050f28358362f6`, `0.1.2-rc.1` | 阶段 B 成员消息运行源 / Phase B member-message runtime source |
...
| 文档摘要 / Documentation digest | `d50788dcfb0fddc76ba052a0e5fa2db3f028e0c06d74be7f58f45de364db2854` | 锁定文档内容 / locked documentation content |
| 扩展接口资格 / Extension API qualification | `agent-team-ultra.phase-b.member-messages.v1` | Ultra 声明的组合资格标签，不冒充 Harness 导出常量 / Ultra qualification label, not a Harness export |
| Session 格式 / Session format | fork `0`; official comparison `2` | 不可只比较软件版本 / independent from package semver |
| Team 事件 / Team events | legacy `2`; native operation `3` | 显式版本解码 / explicit versioned decoding |
| Team 投影 / Team projection | `4` | fork 增加固定路由、native handle 和回执字段 / fork adds routes, native handles, and receipt fields |
