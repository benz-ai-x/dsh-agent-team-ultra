...
| 维护 fork / Maintained fork | `d2d870fbe40bc0e968abdac854a3aae495162bec`, `0.1.2-rc.1` | 阶段 B 持久消息读写运行源 / Phase B persisted-message read/write runtime source |
...
| 文档摘要 / Documentation digest | `9e71a33224fa8755fd225764705ea16b6cc7df351edbf908e184153bf2048d8a` | 锁定文档内容 / locked documentation content |
