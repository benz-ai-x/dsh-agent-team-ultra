...
- [ ] [A04 / #22](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/22): [PR #48](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/48) targets `main`. Review fixes include full Ultra/Host/UI/Profile closure, actual Loader-root admission, ESM-only resolution including module type, and expanded official/fork cold-recovery probes. Clean-build `pnpm verify` passes 448 strict checks, 191 tests and eight-archive install/boot/uninstall; the fixed official/fork comparison passes 11 public contract groups. Independent Standards / Spec re-review remains before the user-authorized merge.
- [ ] Integrate #23–#25 through their separate [PR #49](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/49), [PR #50](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/50), and [PR #51](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/51); those feature increments are absent from this branch. Preserve #26 work in the main workspace and continue #26–#44 under their dependency and integration requirements.
