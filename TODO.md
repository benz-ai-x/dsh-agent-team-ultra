...
User instruction (2026-09-05): close implementation issues once development and validation pass; PR creation and reviews remain independent tasks. #19–#24 meet this condition, but GitHub closure is pending authentication (`gh issue close 19` was rejected before any state change).
...
- [ ] Continue open implementation issues #25–#44 in order after A06, preserving their dependency and integration-branch requirements. Leave Spec #18 open for the final acceptance audit.
