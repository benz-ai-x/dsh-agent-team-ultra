...
User instruction: close implementation issues once development and validation pass; track PR review and merge separately. GitHub CLI is authenticated, and #19–#25 are closed.

- [ ] Deliver [vNext Spec #18](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/18) through all A/B/C acceptance criteria; keep the parent Spec open.
- [x] [A01 / #19](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/19): Host/Profile/evaluation consolidation, validated and merged in [PR #45](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/45).
- [x] [A02 / #20](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/20): launch/recovery, Run repair and Studio projection, validated and merged in [PR #46](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/46).
- [x] [A03 / #21](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/21): locked source preparation, validated and merged in [PR #47](https://github.com/benz-ai-x/dsh-agent-team-ultra/pull/47).
- [x] [A04 / #22](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/22): complete dependency closure, Loader-root admission, ESM/module-type checks and 11 public comparison groups validated in PR #48; merged to main as `debde06` after final Standards / Spec review passed.
- [x] [A05 / #23](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/23): Ultra-owned Codex, full main compatibility admission and Profile-derived archive closure validated; PR #49 passed final Standards / Spec review and merged as `081357d`.
- [x] [A06 / #24](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/24): Ultra-owned Claude Code and the shared archive upgrade driver pass 554 strict checks, 218 tests, both JSON/SQLite upgrade paths and the 11-group comparison. PR #50 passed final Standards / Spec review and merged as `cd15e97`.
- [ ] [A07 / #25](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/25): PR #51 adds read-only migration audit, shared pure storage validation and ADR 0016. Original review fixes preserve legacy Binding normalization and rebuild unreadable caches from canonical Sessions; 243 tests passed before main integration. Current-main full verification passes 554 strict checks, 248 tests and complete archive install/boot/uninstall. Both upgrades and the 11-group comparison pass. The first review found SQLite cache failure and cross-Team payload admission gaps; six new regressions reproduce both and all 36 audit cases now pass. Final full verification passes 554 strict checks, 254 tests and complete archive install/boot/uninstall. Complete incremental review before the user-authorized merge.
- [ ] Preserve #26 WIP and remaining #26–#44 requirements; those later feature increments are absent from this branch.
