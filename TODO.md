...
- [ ] [A05 / #23](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/23): PR #49 moves Codex into Ultra while retaining provider/row/Profile/member/native handle identity. Current main's #48 compatibility fixes are integrated; full verification passes 506 strict checks, 204 tests and eight-archive install/boot/uninstall. The current-main archive upgrade and official/fork comparison pass. T-14 archive validation now compares complete Profile package identities instead of a fixed count; the corrected upgrade passes again. Final independent Standards / Spec re-review remains before the user-authorized merge.
- [ ] Integrate #24–#25 through PR #50–#51; preserve #26 WIP and the remaining #26–#44 requirements. Those later feature increments are absent from this branch.
