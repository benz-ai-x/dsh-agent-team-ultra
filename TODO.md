...
- [ ] [A06 / #24](https://github.com/benz-ai-x/dsh-agent-team-ultra/issues/24): PR #50 moves Claude Code into Ultra while preserving SDK/native qualification, permissions, Catalog Owner and stable Session/member identity. Current main is integrated and full verification passes 554 strict checks, 218 tests and actual archive install/boot/uninstall. Both upgrades share Profile-derived archive identity validation; both real upgrades and the 11-group official/fork comparison pass. Spec review has no findings; the Standards duplication suggestion is addressed through one shared upgrade driver and both actual upgrades pass again. Finish incremental review before the user-authorized merge.
- [ ] Integrate #25 through PR #51; preserve #26 WIP and all remaining #26–#44 requirements. Those later feature increments are absent from this branch.
